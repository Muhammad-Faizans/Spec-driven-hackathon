...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "http://localhost:3001",  # Additional common port for development
        "http://127.0.0.1:8000",  # Self-origin for API calls
        "http://localhost:8000",  # Self-origin for API calls
        "https://*.vercel.app"    # Allow all Vercel frontend domains
    ],
    ...
    try:
        ...
        try:
            ...
            if point_count == 0:
                ...
                print(f"Collection already has {point_count} points, skipping ingestion.")
...
if __name__ == "__main__":
    import uvicorn
    import os
    port = int(os.environ.get("PORT", 8000))  # Use PORT from environment, default to 8000 if not set
